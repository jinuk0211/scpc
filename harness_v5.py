...
def _final_clarify_reason(state: dict[str, Any], target: str) -> str | None:
    ...
    if (
        ...
        and state.get("route_candidate_snapshot") == "mixed_local_external_candidates"
...
submission_payload = run_harness(screening_tasks, FinalHarness, harness_name="recency_harness_v5")
